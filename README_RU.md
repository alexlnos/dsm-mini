...
Всё, что спрашивал мастер, лежит в одном файле
`/var/packages/dsm-mini/var/config.env`. Проще всего поменять значение,
установив пакет поверх самого себя — мастер спросит заново. Править файл
напрямую можно по SSH; после правки остановите и запустите пакет в Центре
пакетов.
