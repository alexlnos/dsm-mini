...
export const ru = {
  ...
  "fail.diskFull": "на томе кончилось место",
  "fail.destination": "папки нет или в неё закрыт доступ",
  "fail.link": "ссылка не работает",
  "fail.timeout": "истекло время ожидания",
  "fail.duplicate": "такая задача уже есть",
  "fail.torrent": "торрент-файл испорчен",
  "fail.extract": "не удалось распаковать",
  ...
  'notify.hint': 'Что бот может написать вам без спроса.',
  'notify.off': 'Ничего',
  'notify.offHint': 'Бот отвечает, но первым не пишет',
  'notify.downloads': 'Только загрузки',
  'notify.downloadsHint': 'Сообщение, когда загрузка завершилась или упала',
  'notify.all': 'Всё',
  'notify.allHint': 'И то, о чём сообщает сам NAS: диски, безопасность, обновления',
